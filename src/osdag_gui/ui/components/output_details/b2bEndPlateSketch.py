...
class B2BEndPlateSketch(QDialog):
    ...
    def createDrawingFlushedReversible(self):
        ...
        print('stiff thicknes:', stiffener_thickness,
              'stiff width : ', stiffener_width)
        h_gap = 12.5
        ...
        self.addHorizontalDimension(
            start_x, dim_y, start_x + plate_thickness, dim_y, str(plate_thickness), blackpen)
        self.addHorizontalDimension(
            start_x, dim_y, start_x - beam_width, dim_y, str(beam_width), blackpen)
        self.addVerticalDimension(start_x-beam_width-20, start_y, start_x -
                                  beam_width-20, start_y+plate_height, str(plate_height), blackpen)
...
# Coordinates for the top-left corner of the left plate
        ...
        points_tl = [QPointF(x1, y1), QPointF(x2, y2), QPointF(
            x3, y3), QPointF(x4, y4), QPointF(x5, y5)]
        ...
        polygon_tl = QGraphicsPolygonItem(QPolygonF(
            [QPointF(x4, y4), QPointF(x5, y5), QPointF(x6, y6), QPointF(x7, y7)]))
        polygon_tl.setPen(pen)
        ...
        points_tr = [QPointF(x1, y1), QPointF(x2, y2), QPointF(
            x3, y3), QPointF(x4, y4), QPointF(x5, y5)]
        ...
        self.addHorizontalDimension(
            start_x, start_y-40, start_x-stiffener_width, start_y-40, str(stiffener_width), blackpen)
        xpos = start_x + 2*plate_thickness + stiffener_width+20
        self.addVerticalDimension(
            xpos, start_y, xpos, start_y+stiffener_height, str(stiffener_height), blackpen)
...
# Coordinates for the top-left corner of the left plate
        ...
        x3, y3 = start_x - stiffener_width, start_y + \
            plate_height - stiffener_height + offset_len
        x4, y4 = start_x - stiffener_width, start_y + plate_height - stiffener_height
        x5, y5 = start_x, start_y + plate_height - stiffener_height
        points_bl = [QPointF(x1, y1), QPointF(x2, y2), QPointF(
            x3, y3), QPointF(x4, y4), QPointF(x5, y5)]
